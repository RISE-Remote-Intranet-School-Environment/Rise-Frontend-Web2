            ...
            <table id='weektable' style={{ borderCollapse: 'collapse', border: '1px solid black' }}>
                <thead>
                    <tr style={{ height: '30px', backgroundColor: 'rgb(198, 197, 197)' }}>
                        <th style={{ border: '1px solid black', width: '4vw' }}></th>
                        {getWeekDays().map((day) => (
                            <th key={day.getTime()} style={{ border: '1px solid black', width: '14vw', fontSize: '15px' }}>
                                ...
                                >
                                    {courses
                                        ...
                                        .map((course) => {
                                            ...
                                            const buttonHeight = length * 60;

                                            return (

                                                <div key={course.id} className='container'>
                                                    <button id="button" className={'event ' + course.groupId.substring(1)}
